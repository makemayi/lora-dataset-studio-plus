...
# --- Re-exports: Phase 8 file split (2026-08) -------------------------------
from .face_scoring_service import (
    FACE_SCORING_STATUSES, face_scoring_counts, face_scoring_rows,
    analyze_faces, analyze_image_face, _face_score_content_revision,
)
from .dataset_export_service import (
    style_content_caption, write_export_zip, build_export_zip,
    write_caption_files, _dataset_info, _export_caption, _TRAIN_FAMILY_LABELS,
)

# --- Re-exports: dataset_backup_service.py (Phase 7 file split, 2026-08) ----
from .dataset_backup_service import (
    BACKUP_FORMAT, BACKUP_VERSION, _BACKUP_MAX_FILES, _BACKUP_MAX_ROWS,
    _BACKUP_MAX_BYTES, _BACKUP_MAX_METADATA_BYTES, _BACKUP_MAX_IMAGE_BYTES,
...
from .dataset_generation_service import (
    ...
    seedvr2_upscale_replace, topaz_upscale_replace,
    topaz_upscale_replace_batch, link_topaz_completed, link_topaz_image,
