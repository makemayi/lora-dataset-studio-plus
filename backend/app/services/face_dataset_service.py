...
# FIRST of the re-export blocks, and that order is load-bearing: the Phase 1
# and Phase 2 modules borrow names defined here (face_crop_to_square_webp,
# _preserved_import_header_extension, _dhash, _existing_dhashes,
# _parse_watermark_bbox, classify_images). Their borrow reaches back into THIS
# module, so the names have to be bound before those imports run.
