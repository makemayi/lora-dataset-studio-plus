...
/* The fold moved to components/common/HelpText.jsx on 2026-08-10 — the same
   measurement came back for the workspace, the bank and the studio, so the
   component belongs where all of them can reach it. Re-exported because the
   settings sections import it from here. */
export { HelpText }
