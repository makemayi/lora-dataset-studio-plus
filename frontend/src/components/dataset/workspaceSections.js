...
export const WORKSPACE_SECTIONS = [
  ...
  { id: 'add', title: 'Add images', icon: 'plus', eyebrow: 'build',
    description: '',
  ...
  { id: 'images', title: 'Images', icon: 'image', eyebrow: 'overview',
  ...
  { id: 'scrape', title: 'Scrape', icon: 'search', eyebrow: 'build',
  ...
  { id: 'curation', title: 'Curation', icon: 'wand', eyebrow: 'quality',
  ...
  { id: 'captions', title: 'Captions', icon: 'caption', eyebrow: 'text',
  ...
  { id: 'export', title: 'Import & export', icon: 'download', eyebrow: 'data',
  ...
  { id: 'training', title: 'Training', icon: 'training', eyebrow: 'train',
  ...
  { id: 'checkpoints', title: 'Checkpoints & LoRAs', icon: 'folder', eyebrow: 'results',
  ...
  { id: 'studio', title: 'Studio', icon: 'studio', eyebrow: 'test',
