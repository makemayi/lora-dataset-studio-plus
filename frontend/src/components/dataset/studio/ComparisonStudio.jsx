  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-4 items-start">
      <aside className="flex flex-col gap-3 lg:sticky lg:top-16 lg:max-h-[calc(100vh-7rem)] lg:overflow-auto">
        ...
        {baseNote && (
          <p className={`m-0 rounded-lg ${FLOAT_SHADOW} border border-amber-400/30 bg-amber-400/5 px-3 py-2
        ...
        {baseModels.length > 0 && (
          <div className={`flex flex-col gap-1 rounded-lg bg-surface ${FLOAT_SHADOW} p-3`}>
            ...
            <select
              ...
              className={`rounded-lg bg-surface-raised ${FLOAT_SHADOW} px-1.5 py-1 text-content text-sm`}
            >
              {baseModels.map((m) => (
