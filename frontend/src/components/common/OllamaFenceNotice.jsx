  ...
  return (
    <div role="status" aria-live="polite"
      className={`rounded-lg border px-3 py-2 text-[0.6875rem] ${waiting
        ...
        : 'border-rose-400/40 bg-rose-50'} ${className}`}>
      <div className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5">
        {model.busy
          ? <span className="inline-block w-3 h-3 border-2 border-amber-200 border-t-amber-400 rounded-full animate-spin" aria-hidden />
