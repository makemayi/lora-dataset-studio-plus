...
const TOPICS = [
  ...
  setting('krea.character_lora', 'engines', 'krea-character-lora', 'Krea 2 Edit character LoRA',
    ['krea', 'character lora', 'character', 'person lora', 'second lora', 'two loras',
     'ai-toolkit', 'trained lora', 'consistency', 'likeness', 'local engine']),
  setting('krea.character_lora_strength', 'engines', 'krea-character-lora-strength',
    'Krea 2 Edit character LoRA strength',
    ['krea', 'character lora', 'strength', 'weight', 'slider', 'local engine']),
